      ...
      <Box sx={{ display: "flex", alignItems: "center", marginTop: "10px" }}>
        ...
        <LocalizationProvider dateAdapter={AdapterDayjs}>
          <DesktopDatePicker
            ...
            onChange={(newValue) => {
                // Проверяем, является ли newValue массивом
                if (Array.isArray(newValue)) {
                  // Преобразуем каждое значение в экземпляр dayjs, если это необходимо
                  const transformedValue = newValue.map(date => dayjs(date));
