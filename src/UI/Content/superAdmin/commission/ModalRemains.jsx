...
export default function ModalRemains({ openStates, close, commision }) {
  ...
  return (
    <div>
      ...
      <AddReciever isOpen={addModal} close={setAddModal} commisionRecieverId={commisionReceiver.id}></AddReciever>
    </div>
  );
}
