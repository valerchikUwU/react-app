...
import { putEditUser } from "../../../../BLL/superAdmin/usersSuperAdminSlice.js";
...
export default function EditUser({
  ...
  const account = useSelector((state) => state.superAdminUsers.editAccount);
  const organizations = useSelector(
    (state) => state.superAdminUsers.editOrganizations
  );
